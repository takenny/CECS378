...
public class lab1 {
   ...
   public static void main(String[] args) {
       ...
       switch (input) { //switch statement for easy change of inputs 
           case 1:
               toDecode = "fqjcb rwjwj vnjax bnkhj whxcq nawjv nfxdu mbvnu ujbbf nnc"; //first problem of assignment to decode 
               decode(toDecode);
               break;
           ...
           case 2:
               ...
               decode(toDecode); //second problem to decode 
               break;
           ...
           case 3:
               ...
               decode(toDecode); //third problem to decode 
               break;
           ...
           case 4:
               ...
               decode(toDecode); //fourth problem to decode 
               break;

           default:
               System.out.println("Wrong input please try again"); //default for wrong inputs 
               break;
